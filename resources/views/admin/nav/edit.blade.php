    ...
    <form action="{{route('nav.update',['nav'=>$data->id])}}" method="post"  class="">
        ...
        <table >
            <tr>
                ...
                <td><input type="text" name="admin_nav_key" id="admin_nav_key" readonly value="{{$data->admin_nav_key}}"></td>
            </tr>
            <tr>
                <td><label for="admin_nav_name">連結名稱:</label></td>
                <td><input type="text" name="admin_nav_name" id="admin_nav_name" value="{{$data->admin_nav_name}}"></td>
            </tr>
            <tr>
                <td> <label for="admin_nav_route">短連結:</label></td>
                <td><input type="text" name="admin_nav_route" id="admin_nav_route" value="{{$data->admin_nav_route}}"></td>
            </tr>
            <tr>
                <td></td>
                <td class="text-end">
